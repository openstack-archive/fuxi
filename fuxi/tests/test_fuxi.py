...
class TestFuxi(base.TestCase):
    ...
    def test_volumedriver_create_without_name(self):
        ...
        self.assertIsNot(None, jsonutils.loads(response.data))
    ...
    def test_volumedriver_path(self):
        ...
        for provider in app.volume_providers.values():
            provider.path = mock.MagicMock()
            provider.path.return_value = fake_mountpoint(fake_name)
    ...
    def test_volumedriver_path_with_volume_not_exist(self):
        ...
        for provider in app.volume_providers.values():
            provider.path = mock.MagicMock(side_effect=exceptions.NotFound)
    ...
    def test_volumedriver_get(self):
        ...
        for provider in app.volume_providers.values():
            ...
            provider.show.return_value = fake_mountpoint(fake_name)
