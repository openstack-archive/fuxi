...
from fuxi.volumeprovider import cinderprovider
...
def mock_cinderclient_get(*args, **kwargs):
    raise cinder_exception.NotFound(404)
...
def mock_psutil_execute(*cmd, **kwargs):
    return
...
class TestCinder(base.TestCase):
    ...
    def setUp(self):
        ...
        self.cinderprovider = cinderprovider.Cinder()
        self.cinderprovider.cinderclient = fake_client.FakeCinderClient()

    @mock.patch.object(cinderprovider.Cinder, '_get_connector', mock_connector)
    @mock.patch.object(cinderprovider.Cinder,
                       '_get_docker_volume',
    ...
    @mock.patch.object(cinderprovider.Cinder, '_get_connector', mock_connector)
    @mock.patch.object(utils, 'psutil_execute', mock_psutil_execute)
