...
default_opts = [
    ...
    cfg.BoolOpt('debug',
                default=False,
                help=_('Enable or Disable debug mode for fuxi server.')),
    cfg.StrOpt('volume_joiner',
               default='#',
               help=_('Connect docker volume name and cinder volume '
                      'uuid to make up a mountpoint.')),
    cfg.StrOpt('fstype',
               default='ext4',
               help=_('File system type for volume.')),
...
cinder_opts = [
    ...
    cfg.StrOpt('protocol',
               default='iscsi',
               help=_('This effective when cloud is False.')),
